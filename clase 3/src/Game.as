package 
{
	...
	public class Game extends Sprite
	{
		...
		private function onTimer(e:TimerEvent):void 
		{
			...
			{
			var Mon:Image = new Image(DStarling.assetsManager.getTexture("coin"));
			addChild(Mon);		
			
			Mon.x = Math.random() * stage.stageWidth;
			Mon.y = Math.random() * stage.stageHeight;
		    Mon.name = 'coin';
